...
public class Client implements ActionListener{
	...
	static DataOutputStream dos;
		...
		Client(){
			...
			//add profile picture
			ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("messages/icons/hanisha.png"));
			...
			JLabel name_label = new JLabel("Hanisha");
